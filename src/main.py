...
<main>
    ...
    <div class="container">
        ...
        <header>
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                <h4 class="display-6 fw-left text-body-emphasis">FAQ_title</h4>
            </div>
        </header>
                <p class="d-inline-flex gap-2 text-left">
                  <button class="btn w-100 btn-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample_1" aria-expanded="False" aria-controls="collapseExample_1">
                    Как купить?
                  </button>
                </p>
                <div class="collapse" id="collapseExample_1">
                  <div class="card card-body">
                    Нажмите на кнопку купить и введите Имя и email
                  </div>
                </div>
                <p class="d-inline-flex gap-1">
                  <button class="btn mt-2 w-100 btn-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample_2" aria-expanded="false" aria-controls="collapseExample_2">
                    Как доставить?
                  </button>
                </p>
                <div class="collapse" id="collapseExample_2">
                  <div class="card card-body">
                    Укажите точный адрес в поле - "адресс доставки"
                  </div>
                </div>
                <p class="d-inline-flex gap-1">
                  <button class="btn mt-2 w-100 btn-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample_3" aria-expanded="false" aria-controls="collapseExample">
                    Какая гарантия?
                  </button>
                </p>
                ...
                <div class="collapse" id="collapseExample_3">
                  <div class="card card-body">
                   Гарантия на товар зависит от его категории и всегда указыана в описании под карточкой
                  </div>
                </div>
